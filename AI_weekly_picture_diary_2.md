...
- 사진과 일기의 내용을 함께 반영한 AI 한마디 생성
- 변환된 사진과 일기, 첨삭, 한마디를 하나의 그림일기 이미지로 구성
...
단순한 필터 적용을 넘어, 사진과 일기의 내용을 분석해 첨삭과 한마디까지 제공합니다.
...
AI는 사진과 일기를 함께 분석해 공백 포함 50자 이내의 한마디를 생성합니다. 미리보기와 저장 이미지에서는 최대 2줄로 표시하며, 표시 영역을 초과할 경우 마지막 줄에 말줄임표를 사용합니다.
