...
// Titles should feel like a 6–8-year-old's writing: visibly uneven in
// baseline, rotation and character size, while remaining readable.
export const TITLE_HANDWRITING_STRENGTH = 1.15;
