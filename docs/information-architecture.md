...
현재 동작 화면은 [README의 화면 갤러리](../README.md#동작-화면)와 대응합니다. 날짜별 기록이 가득 찬 경우의 안내 모달, 저장 일기 상세, 저장·공유 모달, 달력 화면도 정상 흐름의 일부로 포함합니다.
...
| 일기 달력      | 월별 완성 기록 확인        | 업로드의 `나의 기록 보기`           | 업로드 또는 일기 뷰어    |
...
| 사진 업로드    | [`02-photo-upload.png`](./screenshots/02-photo-upload.png)                                   | AI 검사 잔여량, 사진 선택            |
| 처리 동의      | [`03-photo-consent.png`](./screenshots/03-photo-consent.png)                                 | 필수 동의 후 파일 선택               |
| 일기 작성      | [`04-write-diary.png`](./screenshots/04-write-diary.png)                                     | 제목·날짜·날씨·낮/밤·본문 입력       |
...
| 일기 달력      | [`10-diary-calendar.png`](./screenshots/10-diary-calendar.png)                               | 월 이동, 완료 도장, 날짜별 기록 진입 |
...
- 각 제작 단계에는 1/3, 2/3, 3/3 진행 상태가 있고 달력에는 단계 표시가 없습니다.
